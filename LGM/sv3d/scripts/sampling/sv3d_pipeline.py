...
# python scripts/sampling/simple_video_sample.py --input_path /mnt/chenjh/Real2Character/dataset/data_views_056/front_view_images/8037708479870036/8037708479870036.png
...
def sv3d_pipe(
    ...
    if version == "sv3d_u":
        ...
        model_config = "sv3d/scripts/sampling/configs/sv3d_u.yaml"
        cond_aug = 1e-5
    elif version == "sv3d_p":
        num_frames = 24
        num_steps = default(num_steps, 50)
        output_folder = default(output_folder, "outputs/simple_video_sample/sv3d_p/")
        model_config = "sv3d/scripts/sampling/configs/sv3d_p.yaml"
        cond_aug = 1e-5
    ...
    for input_img_path in all_img_paths:
        if "sv3d" in version:
            ...
            if image.mode == "RGBA":
                ...
                image = image.convert("RGBA")  # 直接转换为 RGBA 模式，不执行背景移除
        ...
        with torch.no_grad():
            with torch.autocast(device):
                ...
                # return [vid[5], vid[11], vid[17], vid[23]] # sv3d p
            
                return [vid[17], vid[23], vid[5], vid[11]] # sv3d p
            
                # return [vid[4], vid[10], vid[16], vid[23]] # sv3d u
...
if __name__ == '__main__':
    # python scripts/sampling/simple_video_sample.py --input_path /mnt/chenjh/Real2Character/dataset/data_views_056/front_view_images/8037708479870036/8037708479870036.png
    # vid = sample(input_path = '/mnt/chenjh/Real2Character/dataset/data_views_056/front_view_images/25268213934488176/25268213934488176.png', version='sv3d_p')
    vid = sample(input_path = '/mnt/chenjh/Real2Character/dataset/output-50/1100050704346030754/render_0050.png', version='sv3d_p')
    

    
    base_count = 0
    for frame in vid:
        output_folder = '/mnt/chenjh/Real2Character/sv3d/generative-models/outputs/simple_video_sample'
          # 这个变量代表文件名中的一部分，通常是一个序号
        image_path = os.path.join(output_folder, f"sv3dp_aaa1-{base_count:06d}_frame.png")
        base_count += 1
        # 使用 imageio.imwrite 保存图像
        imageio.imwrite(image_path, frame)
        
        
# python scripts/sampling/simple_video_sample.py --input_path /mnt/chenjh/Real2Character/dataset/output-50/1000050438984538394/render_0050.webp --version sv3d_u
# python scripts/sampling/sv3d_pipeline.py --input_path /mnt/chenjh/Real2Character/dataset/output-50/1100050704346030754/render_0050.png --version sv3d_u