...
# from wonder3d.wonder3d_pipeline import Wonder3DPipeline
...
#     '/mnt/chenjh/LargeModels/mvdream-sd2.1-diffusers', # remote weights
...
#     "/mnt/chenjh/LargeModels/imagedream-ipmv-diffusers", # remote weights
#     torch_dtype=torch.float16,
#     trust_remote_code=True,
#     # local_files_only=True,
# )
...
#     '/mnt/chenjh/LargeModels/wonder3d-v1.0', # or use local checkpoint './ckpts'
#     custom_pipeline='/mnt/chenjh/LargeModels/wonder3d-pipeline', 
#     torch_dtype=torch.float16
#     )
#     # 'flamehaze1115/wonder3d-v1.0'
#     # 'flamehaze1115/wonder3d-pipeline'
...
# pipe_image_wonder3d = load_wonder3d_pipeline()

# import sys
# sys.path.append('/mnt/chenjh/Real2Character/LGM')
# # from .mvdiffusion.pipelines import pipeline_mvdiffusion_image

# from wonder3d.mvdiffusion.pipelines.pipeline_mvdiffusion_image import MVDiffusionImagePipeline as Wonder3DPipeline

from mvdream.pipeline_mvdiffusion_image import MVDiffusionImagePipeline

pipe_image_wonder3d = MVDiffusionImagePipeline.from_pretrained(
    '/mnt/chenjh/LargeModels/wonder3d-v1.0', # or use local checkpoint './ckpts'
    custom_pipeline='/mnt/chenjh/LargeModels/wonder3d-pipeline', 
    torch_dtype=torch.float16
)

pipe_image_wonder3d = pipe_image_wonder3d.to(device)

flag = 'pipe_image_wonder3d'
...
def process(input_image, prompt, prompt_neg='', input_elevation=0, input_num_steps=30, input_seed=42):
    ...
    # image-conditioned (may also input text, but no text usually works too)
        ...
        if flag == 'pipe_image_wonder3d':
            # use wonder3d
            images = pipe_image_wonder3d(image, num_inference_steps=20, output_type='pt', guidance_scale=1.0).images
            mv_image = [images[6], images[8], images[9], images[10]]
        else:
            # use mvdream
