...
# from core.provider_objaverse import CustomDataset as Dataset
...
def main():    
    ...
    if opt.data_name == 'gobj':
        print('gobj')
        from core.provider_objaverse import G_ObjaverseDataset as Dataset
    elif opt.data_name == 'real2char':
        print('real2char')
        from core.provider_objaverse import ObjaverseDataset as Dataset
    elif opt.data_name == 'real2char_head':
        print('real2char_head')
        from core.provider_objaverse import Head_ObjaverseDataset as Dataset
    else:
        raise NotImplementedError
    ...
    print(f'opt.num_epochs={opt.num_epochs}')
    print(f'total_steps={total_steps}')
    
    # pct_start = 3000 / total_steps
    pct_start = min(3000 / total_steps, 1.0) # 少量数据用这个
